<%-- 
    Document   : contact
    Created on : Apr 27, 2021, 7:39:56 PM
    Author     : Lapstore.lk
--%>
                ...
                <div class="row">
                    <div class="col-md-7 col-sm-6 map-wrapper">
                        ...
                        <div class="contact-infos">
                            <ul>
                                <li>987 Pitipana Street, Homagama</li>
                                <li>Colombo, Sri Lanka</li>
                                <li>Tel: +94 11 23 78 567</li>
                                <li>Email: <a href="mailto:phoenix@company.com">phoenix@company.com</a></li>
                            </ul>
                        </div>
                    </div>
