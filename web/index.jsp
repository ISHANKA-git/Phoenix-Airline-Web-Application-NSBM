<%-- 
    Document   : index
    Created on : Apr 27, 2021, 7:40:18 PM
    Author     : Lapstore.lk
--%>
                ...
                <div class="main-header">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-xs-10">
                            <div class="logo">
                                <a href="#">
                                    <img src="images/logo.png" alt="Phoenix Airline PVT" title="Phoenix Airline PVT">
                                </a>
                            </div> <!-- /.logo -->
                        </div> <!-- /.col-md-4 -->
                        ...
                        <div class="row">
                            <div class="col-md-5 col-lg-4">
                                <div class="flex-caption visible-lg">
                                    ...
                                    <p>Venice Tours, Top Activities and Things to Do. Find Your Tickets. Book Now. Plan Your Trip To Venice. Find Deals, Order Now. Best Things To Do in Venice.</p>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-lg-4">
                                <div class="flex-caption visible-lg">
                                    ...
                                    <p>Find the best things to do in Barcelona with the help of over 2 million trusted reviews. Our free cancellation policy means you don't have to stress if your travel plans change.</p>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-lg-4">
                                <div class="flex-caption visible-lg">
                                    ...
                                    <p>Discover Basel with GetYourGuide. Top-rated tours and activities for your trip. Feel confident when you book tickets for the top-rated tours and activities for your trip.</p>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="copyright">
                            <span>
                                ...
                                Copyright &copy; 2022 <a href="#">NSBM MIS 21.1 Batch</a>
